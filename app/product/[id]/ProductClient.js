...
export default function ProductClient({ productId, initialProduct = null }) {
  ...
  if (!product) {
    return (
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
        ...
        <p className="text-gray-600 mb-8">{loadError || "The product you're looking for doesn't exist."}</p>
